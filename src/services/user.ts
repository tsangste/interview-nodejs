...
const users: User[] = [
  ...
  {
    id: 1001,
    name: 'ranneocitylights',
    email: 'ranneocitylights@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
  {
    id: 1002,
    name: 'gladiatormemento',
    email: 'gladiatormemento@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
  {
    id: 1003,
    name: 'toystoryinsideout',
    email: 'toystoryinsideout@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
  {
    id: 1004,
    name: 'casinoallabouteve',
    email: 'casinoallabouteve@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
  {
    id: 1005,
    name: 'neoragingbullolaf',
    email: 'neoragingbullolaf@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
  {
    id: 1006,
    name: 'platoonranbatman',
    email: 'platoonranbatman@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
  {
    id: 1007,
    name: 'downfallgromitneo',
    email: 'downfallgromitneo@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
  {
    id: 1008,
    name: 'heattaxidriverred',
    email: 'heattaxidriverred@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
  {
    id: 1009,
    name: 'ironmanranbatman',
    email: 'ironmanranbatman@domain.com',
    password: 'password',
    active: false,
    token: '',
  },
